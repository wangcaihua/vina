...
struct ifile
    : public boost::filesystem::ifstream {  // never use ifstream pointer to
                                            // destroy ifile - no virtual
                                            // destructors, possibly
...
struct ofile
    : public boost::filesystem::ofstream {  // never use ofstream pointer to
                                            // destroy ofile - no virtual
                                            // destructors, possibly
