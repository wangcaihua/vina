...
// these 4 lines are used 3 times verbatim - defining a temp macro to ease the
// pain
...
class matrix {
 ...
 public:
  ...
  void resize(sz m, sz n,
              const T& filler_val) {  // new sizes should be the same or greater
                                      // than the old
